  ...
  function renderCurrentPage() {
    if (step === 1) {
      return (
        <>
          {showError && (
            <div className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 bg-red-50 border-2 border-red-500 text-red-600 px-6 py-3 rounded-lg font-semibold shadow-lg animate-glow">
